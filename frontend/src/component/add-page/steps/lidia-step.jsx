            ...
            <Page>
                <SectionWithTitle title='Tienta'>
                    <BirthSectionTitle title='Fecha de la tienta (opcional)'>
                        <CustomInput name='day' value={Date.day} handleChange={handleDate} paddingWrapper='0' placeholder='Dia' maxLength='3' pattern="[0-9]" />
                        <CustomInput name='month' value={Date.month} handleChange={handleDate} paddingWrapper='0' placeholder='Mes' maxLength='3' pattern="[0-9]" />
                        <CustomInput name='year' value={Date.year} handleChange={handleDate} paddingWrapper='0' placeholder='Año' maxLength='5' pattern="[0-9]" />
                    </BirthSectionTitle>
